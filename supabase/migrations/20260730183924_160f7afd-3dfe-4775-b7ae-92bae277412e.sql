...
BEGIN
  PERFORM public.notify_admins(
    ...
    '/admin',
    jsonb_build_object('eventLabel', 'Redefinição de 2FA', 'source_table', 'two_fa_reset_requests', 'source_id', NEW.id)
  );
  RETURN NEW;
...
BEGIN
  ...
  PERFORM public.notify_admins(
    ...
    '/admin',
    jsonb_build_object('eventLabel', 'Fila de e-mails', 'total', total)
  );
